...
from slowfast.models.head_greathits import GreatHitsHead
...
class SlowFast(nn.Module):
    ...
    def _construct_network(self, cfg):
        ...
        if cfg.DETECTION.ENABLE:
            ...
            if cfg.TRAIN.DATASET == "greathits" or cfg.TEST.DATASET == "greathits":
                self.head = GreatHitsHead(
                    dim_slow=width_per_group * 32,
                    dim_fast=width_per_group * 32//cfg.SLOWFAST.BETA_INV,
                    num_classes= cfg.MODEL.NUM_CLASSES,
                    dropout_rate=cfg.MODEL.DROPOUT_RATE)
